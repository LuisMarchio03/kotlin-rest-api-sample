...
set CLASSPATH=%APP_HOME%\lib\com.example.ktor-sample-all.jar

@rem Execute com.example.ktor-sample
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COM_EXAMPLE_KTOR_SAMPLE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
